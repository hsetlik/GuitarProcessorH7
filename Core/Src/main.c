...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, LED_NRST_Pin|CODEC_NRST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_NRST_Pin CODEC_NRST_Pin */
  GPIO_InitStruct.Pin = LED_NRST_Pin|CODEC_NRST_Pin;
